...
// Manages the formulation and rendering of sentences.
class SentenceManager
{
    ...
    void AllocateSentenceVertices(const std::string& sentence, int pixelHeight, glm::vec3 textColor, SentenceInfo& sentenceInfo);

    void ClearCharacterData(const SentenceInfo& sentenceInfo);
    void DeleteSentence(SentenceInfo& sentenceInfo);
